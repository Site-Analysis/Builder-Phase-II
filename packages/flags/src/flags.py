...
class FeatureFlag(StrEnum):
    ...
    INFRASTRUCTURE_POWER_GRID = "feature.infrastructure.power-grid"
    ...
    REPORT_GO_NO_GO = "feature.report.go-no-go"
    ...
    GEO_TRANSPORT_ACCESS = "feature.geo.transport-access"
    ...
    CADASTRAL_OVERLAYS = "feature.cadastral.overlays"
    CADASTRAL_EXPLORER = "feature.cadastral.explorer"
