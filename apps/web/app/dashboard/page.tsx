  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 1px 4px rgba(101,113,102,0.07), 0 4px 16px rgba(101,113,102,0.05)",
      }}
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(-3px)";
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 8px 32px rgba(101,113,102,0.16), 0 2px 8px rgba(101,113,102,0.08)";
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)";
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 1px 4px rgba(101,113,102,0.07), 0 4px 16px rgba(101,113,102,0.05)";
      }}
      ...
      <div style={{ position: "relative", height: 160, overflow: "hidden" }}>
        ...
        {project.overall_score != null && (
          <div style={{
            ...
            boxShadow: "0 2px 8px rgba(101,113,102,0.12)",
  ...
  return (
    ...
    >
      ...
      <svg style={{ position: "absolute", top: -24, left: -24, opacity: 0.07, pointerEvents: "none" }}
        ...
        <circle cx="50" cy="50" r="46" stroke="#657166" strokeWidth="1"/>
        <circle cx="50" cy="50" r="30" stroke="#657166" strokeWidth="1"/>
      </svg>
...
function GhostCard({ variant }: { variant: number }) {
  return (
    <div style={{
      ...
      boxShadow: "0 1px 4px rgba(101,113,102,0.04)",
    }}>
...
function WelcomeHero({ onStart }: { onStart: () => void }) {
  return (
    <div style={{
      ...
      boxShadow: "0 2px 12px rgba(101,113,102,0.07)",
    }}>
      {/* Left — copy */}
      <div style={{
        ...
        <div style={{ fontSize: 13, color: "#7B8F83", lineHeight: 1.65, marginBottom: 18, maxWidth: 340 }}>
          SAT pulls climate, flood, solar, wind, and regulatory data from authoritative sources — cited and ready to export.
        </div>
        {/* Module chips */}
        ...
        <button
          onClick={onStart}
          style={{
            height: 40, padding: "0 22px", background: "#657166", color: "white",
            border: "none", borderRadius: 10, fontSize: 13, fontWeight: 600,
            cursor: "pointer", fontFamily: "inherit",
            transition: "background 0.15s",
          }}
          onMouseEnter={(e) => { (e.currentTarget).style.background = "#4D5850"; }}
          onMouseLeave={(e) => { (e.currentTarget).style.background = "#657166"; }}
        >
...
const STAT_META = [
  ...
  {
    accent: "#657166", tint: "rgba(101,113,102,0.07)",
    icon: CalendarDays, iconColor: "#657166",
    label: "This month",
  },
] as const;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: dim ? "rgba(101,113,102,0.06)" : `${meta.accent}18`,
    ...
    >
      ...
      <div style={{
        ...
        <p style={{
          ...
          SAT aggregates flood risk, solar gain, wind climatology and regulatory constraints — cited from authoritative sources, exported in one click.
        </p>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button
            onClick={onStart}
            style={{
              height: 44, padding: "0 24px", background: "#657166", color: "white",
          ...
          <button
            ...
            style={{
              ...
              border: "1.5px solid #CFD6C4", borderRadius: 12,
              fontSize: 13, fontWeight: 600, color: "#7B8F83",
              cursor: "pointer", fontFamily: "inherit",
              transition: "background 0.15s, border-color 0.15s",
            }}
            onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(207,214,196,0.20)"; }}
