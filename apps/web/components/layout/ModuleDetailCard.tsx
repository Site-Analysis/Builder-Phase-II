      ...
      <div style={{ padding: "16px 16px 0", borderBottom: "1px solid #CFD6C4", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 11, color: "#7B8F83", marginTop: 2, lineHeight: 1.4 }}>
              ...
              <div style={{ marginBottom: 4 }}>
                {indicators.map((ind, i) => (
                  <div key={ind.label} style={{
                    ...
                    padding: "8px 0", borderBottom: i === indicators.length - 1 ? "none" : "1px solid #CFD6C4",
                  }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 12, color: "#7B8F83" }}>{ind.label}</div>
                      {ind.citation && <div style={{ fontSize: 10, color: "#B8C4BB", marginTop: 1 }}>{ind.citation}</div>}
                    </div>
                    <span style={{
              ...
              <div key={grp.group} style={{ marginTop: 14 }}>
                ...
                {grp.rows.map((row, i) => (
                  <div key={row.label} style={{
                    ...
                    padding: "6px 0", borderBottom: i === grp.rows.length - 1 ? "none" : "1px solid #CFD6C4",
                  }}>
